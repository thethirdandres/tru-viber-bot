...
module.exports = class Composer {
    ...
    static composeMainMenuElements() {
        ...
        let rob = TemplateBuilder.buildImageTitleButtonTemplate("https://storage.googleapis.com/avigate-img-resources/tru-resources/chatbot-pix_viber-rev-GoCart.jpg", 6, 5, true, "none", "GoCart", "SHOP AT GOCART", 6, 1, true, "open-url", "https://toysrus.gocart.ph/");
        ...
        let met = TemplateBuilder.buildImageTitleButtonTemplate("https://storage.googleapis.com/avigate-img-resources/general/chatbot-pix_viber-rev-Metromart.jpg", 6, 5, true, "none", "Metromart", "SHOP AT METROMART", 6, 1, true, "open-url", "https://www.metromart.com/");
    ...
    static composeLearnMoreElements() {
        ...
        let promosEvents = TemplateBuilder.buildImageTitleButtonTemplate("https://storage.googleapis.com/avigate-img-resources/general/chatbot-pix_viber-rev-Boys-Fair.jpg", 6, 5, true, "none", "Promos and Events", "SELECT", 6, 1, true, "open-url", "https://toysrus.com.ph/catalog");
    ...
    static composeExitQuietModeMsg() {
        ...
        let exitConfirm = TemplateBuilder.buildButtonTemplate("Confirm", 3, 1, true, "reply", "CONFIRM_EXIT");
        let exitCancel = TemplateBuilder.buildButtonTemplate("Cancel", 3, 1, true, "reply", "CANCEL_EXIT");
