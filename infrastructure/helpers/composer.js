...
module.exports = class Composer {
    ...
    static composeMainMenuElements() {
        ...
        let cat = TemplateBuilder.buildImageTitleButtonTemplate("https://storage.googleapis.com/avigate-img-resources/tru-resources/chatbot-viber-girlsfair.jpg", 6, 5, true, "none", "Catalog", "SHOP NOW", 6, 1, true, "open-url", "https://bit.ly/TRUGirls_11");
